            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-7 mx-auto">
                    <div class="flex justify-between bg-slate-100/50 py-1 px-3 border-solid border-b rounded-lg">
                        <x-titulo titulo="Datos del cliente"></x-titulo>
                        <a href="{{ route('inicio') }}"
                    ...
                    <div class="p-4">
                        <table class="cell-border compact stripe compact tablas">
                            ...
                            <tbody class="flex-1 sm:flex-none">
                                ...
                                <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0 hover:bg-gray-100" @if($plan->estado)  style="background-color:#90fb90;" @endif>
