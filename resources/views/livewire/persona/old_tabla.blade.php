...
<div>
    ...
    <div class="grid grid-cols-1 mt-2 xl:mt-2 md:grid-cols-2 xl:grid-cols-1 div-principal">
        <table class="cell-border compact stripe tablas">
            <thead class="">
                <tr
                    class="">
                    ...
                    <th class="p-2" data-label="Estado">Estado</th>
                            ...
                            <td class="border-grey-light border p-3" data-label="Actions">
                                <div class="flex item-center justify-center">
                                    ...
                                    @if(Auth::user()->rol=='admin')
                                      <button data-id="{{$persona->id}}" class="w-4 mx-2 transform hover:text-blue-800 hover:scale-125 btnEditar">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor" data-id="{{$persona->id}}" class="btnEditar">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" data-id="{{$persona->id}}" class="btnEditar" />
                                        </svg>
                                    </button>
                                    <button data-id="{{$persona->id}}" class="w-4 mx-2 transform hover:text-blue-800 hover:scale-125 btnEliminar">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor" data-id="{{$persona->id}}" class="btnEliminar">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" class="btnEliminar" data-id="{{$persona->id}}"/>
                                        </svg>
                                    </button>
                                    @endif
                                </div>
