                ...
                <form wire:submit.prevent="guardar" class="w-full max-w-full p-2">
                    ...
                    <div class="flex flex-wrap mt-3">
                        <div class="w-full md:w-3/3 px-1 mb-2 md:mb-0">
                            <x-jet-label for="plan_id" value="Seleccione Plan*" />
                            <select
                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                wire:model="plan_id" name="plan_id" id="plan_id"
                        ...
                        <div class="w-full md:w-3/3 px-1 mb-2 md:mb-0 mt-3">
                            ...
                            <input wire:model="fecha_inicio" type="date" id="fecha_inicio" placeholder="Fecha de inicio"
                                name="fecha_inicio"
                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" />
                            <x-jet-input-error for="fecha_inicio" class="mt-2" />
                        </div>
                        <div class="w-full md:w-3/3 px-1 mb-2 md:mb-0 mt-3">
                            <x-jet-label for="cantidad_plan" value="Numero de planes*" />
                            <input wire:model="cantidad_plan" type="number" id="" placeholder="Fecha de inicio"
                                name="cantidad_plan"
                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" />
                            <x-jet-input-error for="cantidad_plan" class="mt-2" />
                        </div>
                        <div class="w-full md:w-3/3 px-1 mb-2 md:mb-0 mt-3">
                            <x-jet-label for="sede" value="Seleccione Sede*" />
                            <select
                                class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
