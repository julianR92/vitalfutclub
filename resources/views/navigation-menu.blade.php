<nav x-data="{ open: false }" class="bg-orange-500 border-b border-white">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->rol=='admin')
                        ...
                        <x-jet-nav-link href="{{ route('empresa.index') }}" :active="request()->routeIs('empresa.index')">
                            {{ __('Configurar datos de la empresa') }}
                        </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->rol=='admin')
               <x-jet-responsive-nav-link  href="{{ route('persona.index') }}" :active="request()->routeIs('persona.index')">
