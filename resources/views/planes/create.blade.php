                ...
                <section class="bg-white dark:bg-gray-900">
                    <div class="container px-6 py-7 mx-auto">
                        <div class="bg-slate-100/50 py-1 px-3 border-solid border-b rounded-lg mb-4">
                            <x-titulo titulo="Crear Nuevo Plan"></x-titulo>
                        </div>
                        ...
                        <form action="{{ route('planes.store') }}" method="POST" class="p-4">
                            @csrf
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="tipo_plan" id="tipo_plan"
                                            ...
                                            <option value="prepago" {{ old('tipo_plan') == 'prepago' ? 'selected' : '' }}>Prepago</option>
                                            <option value="suscripcion" {{ old('tipo_plan') == 'suscripcion' ? 'selected' : '' }}>Suscripción</option>
                                        </select>
                                        @error('tipo_plan')
                                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" name="numero_clases" id="numero_clases" min="1"
                                                   ...
                                                   value="{{ old('numero_clases') }}" required>
                                            @error('numero_clases')
                                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="descripcion_corta" id="descripcion_corta" rows="3"
                                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('descripcion_corta') border-red-500 @enderror">{{ old('descripcion_corta') }}</textarea>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="sede_id" id="sede_id"
                                            ...
                                            @foreach($sedes as $sede)
                                                <option value="{{ $sede->id }}" data-ciudad="{{ $sede->ciudad_id }}" {{ old('sede_id') == $sede->id ? 'selected' : '' }}>
                                                    {{ $sede->nombre_sede }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                        ...
                                        <ul class="text-xs text-blue-700 space-y-1">
                                            ...
                                            <li>• Podrás agregar detalles al plan después de crearlo</li>
                                            <li>• El descuento se aplicará automáticamente al precio</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 flex flex-col sm:flex-row justify-end gap-3">
                                ...
                                <button type="submit"
                                        class="bg-black hover:bg-gray-700 text-white hover:text-white px-6 py-2 rounded inline-flex items-center justify-center">
